...
def calculates_results_stats(results_dic):
    ...
    # key = starting with 'pct' for percentage or 'n' for count
    #            n_images - number of images
    #            n_dogs_img - number of dog images
    #            n_notdogs_img - number of NON-dog images
    #            n_match - number of matches between pet & classifier labels
    ...
    n_match, n_dogs_img, n_correct_dogs, n_correct_notdogs, n_correct_breed = 0, 0, 0, 0, 0
    ...
    pct_match = n_match / len(results_dic) * 100.0
    ...
    if results_stats_dic['n_notdogs_img'] > 0:
        pct_correct_notdogs = results_stats_dic['n_correct_notdogs'] / results_stats_dic['n_notdogs_img'] * 100.0
    else:
